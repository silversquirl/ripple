pub const magic_number = 119734787;
pub const version = 65536;
...
pub const ExecutionMode = enum(u16) {
    Invocations = 0,
    SpacingEqual = 1,
...
pub const ImageOperands = enum(u16) {
    Bias = 0,
    Lod = 1,
    Grad = 2,
    ConstOffset = 3,
...
pub const FPFastMathMode = enum(u16) {
    NotNaN = 0,
    NotInf = 1,
    NSZ = 2,
    AllowRecip = 3,
...
pub const SelectionControl = enum(u16) {
    Flatten = 0,
    DontFlatten = 1,
};

pub const LoopControl = enum(u16) {
    Unroll = 0,
    DontUnroll = 1,
};

pub const FunctionControl = enum(u16) {
    Inline = 0,
    DontInline = 1,
    Pure = 2,
    Const = 3,
...
pub const MemorySemantics = enum(u16) {
    Acquire = 1,
    Release = 2,
    AcquireRelease = 3,
...
pub const MemoryAccess = enum(u16) {
    Volatile = 0,
    Aligned = 1,
    Nontemporal = 2,
};
...
pub const KernelProfilingInfo = enum(u16) {
    CmdExecTime = 0,
};
